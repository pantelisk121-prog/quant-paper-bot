...
Linked here is the code to my initial 5-yr back-test on Google Colab: https://colab.research.google.com/drive/1sYzJFaVPMUsmY8VQJ2mDjHrf0jYR2Kq1?usp=sharing 
...
* **Stage 8: Multi-Regime Macro Stress Testing:** To validate structural durability beyond a single 5-year market cycle, the model was tested across extended historical windows. Over a 10-year horizon (2014–2024), the strategy yielded an **11.81% annualized return**, while a 20-year multi-decade stress test (2004–2024) produced a **5.43% annualized return**, proving long-term survival and stability through major economic shocks like the 2008 financial crisis and the 2020 pandemic.
